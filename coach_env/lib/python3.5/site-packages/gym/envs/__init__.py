...
register(
    id='TwoOb-v0',
    entry_point='gym.envs.dr_game:TwoObEnv',
    max_episode_steps=200,
)

register(
    id='WOri-v0',
    entry_point='gym.envs.dr_game:WOriEnv',
)

register(
    id='WOriEntity-v0',
    entry_point='gym.envs.dr_game:WOriEntityEnv',
)

register(
    id='Worien-v0',
    entry_point='gym.envs.dr_game:WorienEnv',
    max_episode_steps=100,
)

register(
    id='Prosp-v0',
    entry_point='gym.envs.dr_game:ProspEnv',
    max_episode_steps=200,
)

register(
    id='Prowo-v0',
    entry_point='gym.envs.dr_game:ProwoEnv',
    max_episode_steps=200,
)
